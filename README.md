...
See `scripts/R/get_microglia_ATAC_barcodes.R` for details. The microglia ATAC-seq object that I used for model training is too large to upload to this repository, however if you have any microglia-specific ATAC-seq ArchR project, the code should work as intended.
