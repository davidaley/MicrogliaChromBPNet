...
mkdir -p $BASE/chrombpnet_model/homeostatic $BASE/logs

echo "Training homeostatic ChromBPNet model: $(date)"
chrombpnet pipeline \
    ...
    -b $BASE/bias_model/homeostatic/models/homeostatic_bias.h5 \
    -o $BASE/chrombpnet_model/homeostatic \
    -fp homeostatic
